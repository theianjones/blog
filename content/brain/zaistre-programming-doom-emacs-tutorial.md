...
1.  [Command Abbreviations](#org32a295d)
2.  [Emacs Doom E02 - Projects with Projectile, File Explorer with Treemacs & EShell](#org9728dc5)
3.  [Emacs Doom E03 - A short intro to Dired](#org102ed70)
4.  [Emacs Doom E04 - Buffers, Windows and Basic Navigation](#org7ad2452)
5.  [Emacs Doom E05: Installing Packages with org-super-agenda as an example](#orgb0e106f)
6.  [Emacs Doom E06: Quick, horizontal movements with evil-snipe](#orgb647fee)
7.  [Emacs Doom E07: Moving around the screen with Avy](#org388daa2)
8.  [Emacs Doom E08: Multiple cursor in Emacs with evil-multiedit](#org30b5cf6)
9.  [Emacs Doom E09: Org Mode, Basic Outlines](#org81c82b8)
10. [Emacs Doom E10: Org Mode, - Links, Hyperlinks and more](#org7e04976)
11. [Emacs Doom E11: Org Mode - Custom Link Types](#orgb701a40)
12. [Emacs Doom E12: Org Mode - Linking to words & Bookmarks](#orgffe76a2)
13. [Emacs Doom E13: Org Mode, Code Snippets 101](#orgb827f37)
14. [Emacs Doom E14: Org Mode, Getting Organized with Tasks](#orgf45e9cc)
15. [Emacs Doom E15: Org Mode, Priorities for Tasks](#org749da92)
    1.  [buy strawberries](#orgdf410b3)
16. [Emacs Doom E16: Org Mode, Marking Tasks with Tags](#orgc34243a)
    1.  [play more games](#orgab01491):fun:
17. [Emacs Org Mode - Using Checkboxes - Emacs Doom 17](#org5121008)
    1.  [You can see how many are done with a &ldquo;cookie&rdquo; <code>[1/2]</code>](#org96c5c45)
18. [Emacs Magit - Getting Started - Emacs Doom 18](#org5c14b98)
19. [Emacs Magit - The Git Commit Flow in More Detail - Emacs Doom 19](#org95ea852)
20. [Emacs Magit with Forge for Issuing Pull Requests - Emacs Doomcasts 20](#org8c30753)
