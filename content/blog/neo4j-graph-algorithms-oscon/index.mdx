---
layout: post
title: 'Graph Algorithms: They are Awesome 🤯'
...
![power law distribution](power-law-distribution.png)
...
![algorithm categories](algorithm-categories.png)

[Free copy of graph algorithms book!](http://neo4j.com/graph-algorithms-book)

Graph algorithms allow you to sort categories of data into buckets. This talk gives an example using the yelp public dataset and how he went for sorting things by 100s of categories down to 15 greater categories. He used an overlap similarity algorithm in neo4j to determine the categories that would be more general (one with more nodes) than one that is specific.
...
![label propagation](label-propagation.png)
